<%-- 
    Document   : vcall
    Created on : 28 Jul, 2021, 7:46:00 PM
    Author     : USERi
--%>
...
//        }
    ...
    <div class="split">
<!--        <form  class="cassign" action="vcallservlet" method="POST">-->
       <div class="cassign">
        VIDEO CALL:<br>
<!--        <input type="submit" value="start a meet" >-->
<a href ="http://localhost:3000" style="color: white" target="_blank">start a meet</a>
        <!--</form>-->
       </div>
