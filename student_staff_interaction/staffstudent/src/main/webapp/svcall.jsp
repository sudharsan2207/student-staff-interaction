<%-- 
    Document   : svcall
    Created on : 28 Jul, 2021, 8:02:25 PM
    Author     : USERi
--%>
...
//        vcallservlet call = new vcallservlet();
//        try {
//            call.getdoubts(request, response);
...
//        }
    ...
    <div class="split">
        <form  class="cassign" action="vcallservlet" method="POST" id="room">
        VIDEO CALL:<br>
        
        </form>
<!--    <div class="cassign">
        <a href="http://localhost:3000/1" style=>Join meet</a>
    </div>-->
 </div> 
 <footer style="background-color:rgb(73, 18, 18);position:absolute;margin-top: 100vh;">
    ...
    <script>
        var roomID = "<%=roomID%>";
        document.getElementById("room").innerHTML +="<a href='http://localhost:3000/1' style='color:blue' target='_blank'>Join meet</a>";
    </script>
</body>
</html>
